...
Page({
   ...
   */
  data: {
    editionClass:[{id:'Barrens',name:'贫瘠之地'},{id:'BarrensMini',name:'贫瘠之地迷你'},{id:'stormwind',name:'暴风城下的集结'},{id:'stormwindMini',name:'暴风城下的集结迷你'},{id:'Alterac',name:'奥特兰克的决裂'},{id:'AlteracMini',name:'奥特兰克的决裂迷你'},{id:'SunkenCity',name:'探索沉没之城'}],
  },
